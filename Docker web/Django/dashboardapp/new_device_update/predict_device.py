...
#저장된 기기 각각 실행
def new_perdict_insert(device_ID):
    upd_count = 0 # 업데이트 횟수
    ...
    print(f"CALCULATION MODUL GENERATE | {get_time.get_today('-')} {get_time.get_now_time()}, UPDATE RATE : {upd_count}, INSERT RATE : {ins_count}")
    return
